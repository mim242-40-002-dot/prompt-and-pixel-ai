...
The public interface uses original CSS-built portraits and a custom `HV` mark. It does not include Marvel or DC logos, actor likenesses, movie stills, comic scans, traced work, copied commercial layouts, or hotlinked promotional artwork. Green Arrow is identified as a DC guest; the seven other profiles are identified as Marvel characters.
